...
public class EShop implements EShopInterface {
    ...
    public List<Kunde> getAlleKunden() {
        return kv.getKundenListe();
    }

    @Override
    public List<Ereignis> getAlleEreignisse() {
        return av.getEreignisListe();
    }
    ...
    //Methode wird getriggert, wenn sich ein Kunde Einloggt
    @Override
    ...
    //String der alle Artikel ausgibt
    ...
    public List<Ereignis> ereignisseNachDatum() {
        return av.ereignisseSortiertNachDatum();
    }


    //Methode wird auch verwendet werden zum abändern der Menge
    @Override
    ...
    //leert den Warenkorb auf Wunsch des Kunden
    @Override
